...
<html>
    ...
    <body>
		...
		<div class="container-fluid hero" style="background:#f7f7f7">
            <div class="container">
				<div class="row">
					<div class="col-md-12">
							...
							<table class="table table-striped">
							  ...
							  <tbody>
									<?php $i = 1; foreach($reqs as $key => $req){ ?>
										<tr>
											<td scope="row"><?php echo $i; ?></t>
											<td><?php echo $req['job_type']; ?></td>
											<td><?php echo $req['range_age_employee']; ?></td>
											<td><?php echo $req['employee_nationality']; ?></td>
											<td><?php echo $req['work_to_be_done']; ?></td>
										</tr>
									<?php $i++; } ?>
